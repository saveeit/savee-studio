...
function SortableAsset({
  ...
  return (
    ...
    >
      ...
      <span
        className="h-10 w-8 shrink-0 rounded-[6px] bg-cover bg-center ring-1 ring-white/10"
...
export function SettingsPanel() {
  const canvas = useAnimator((s) => s.canvas);
      ...
      <div className="scroll-thin flex-1 overflow-y-auto">
        <Section title="Canvas">
          ...
          <Toggle
            ...
            onChange={(v) => setCanvas({ safeArea: v })}
          />
        </Section>
        ...
        <Section title="Assets">
          ...
          <div className="mb-2.5 flex items-center justify-between">
            ...
            {assets.length > 0 && (
              <button
                onClick={clearAssets}
                className="text-[12px] text-gray-500 hover:text-danger"
              >
                Clear all
              </button>
            )}
